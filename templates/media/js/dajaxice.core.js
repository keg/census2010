var Dajaxice = {
        ...
        data: {
            ...
            update_map: function(callback_function, argv){
                Dajaxice.call('data.update_map', callback_function, argv);
            }
    ...
    call: function(dajaxice_function, dajaxice_callback, argv)
    {
        ...
        oXMLHttpRequest.open('POST', '/census/dajaxice/'+dajaxice_function+'/');
